...
export default function More() {
  return (
    <Popover className='relative'>
        ...
        <Popover.Panel className='w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden flex flex-col'>
            ...
            <div className="flex w-[89%] self-center">
                <hr className="h-[1px] w-full my-[2px] bg-[#38444d]"/>
            </div>
            

            <Disclosure>
                <Disclosure.Button className="py-2 h-[52px] flex items-center w-full px-4 font-bold transition-colors hover:bg-[#eff3f41a] justify-between">
                    Creator Studio
                ...
                <Disclosure.Panel >
                    <Link to={'/'} className="py-2 h-[44px] flex items-center w-full px-4 transition-colors hover:bg-[#eff3f41a] text-[15px] font-medium">
                        <svg viewBox="0 0 24 24" className="mr-[12px] h-[1.25em] relative max-w-full inline-block">
                            <path
                                fill="#fff"
            ...
            <Disclosure>
                ...
                <Disclosure.Panel className="py-2 h-[44px] flex items-center w-full px-4 transition-colors hover:bg-[#eff3f41a] text-[15px] font-medium">
                    <Link to={'/'}>
                        <svg viewBox="0 0 24 24" className="mr-[12px] h-[1.25em] relative max-w-full inline-block">
                            <path
                                fill="#fff"
                ...
                <Disclosure.Panel className="py-2 h-[44px] flex items-center w-full px-4 transition-colors hover:bg-[#eff3f41a] text-[15px] font-medium">
                    <Link to={'/'}>
                        <div role="presentation" className="flex">
                            ...
                            <svg viewBox="0 0 24 24" className="mr-[12px] h-[1.25em] absolute max-w-full inline-block">
                                <path
                                    fill="#1d9bf0"
